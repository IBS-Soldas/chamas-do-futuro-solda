...
const AdminCourses = () => {
    ...
    const purchasedCourses = courses.map(course => {
        const progressData = getProgressData(Number(course.id));
        ...
        <div className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-blue-500/10 to-purple-500/10 backdrop-blur-md border border-blue-500/20 rounded-lg p-6">
                ...
                <p className="text-gray-300 mb-4">
                    Aqui você acessa todos os cursos
                </p>
                    ...
                    >
                        ...
                        <div className="relative overflow-hidden rounded-t-lg">
                            <img
                                ...
                                src="https://tse2.mm.bing.net/th/id/OIP.ljHpcpI3IWbKfscwHv6LwgHaHa?rs=1&pid=ImgDetMain&o=7&rm=3"
                                alt={course.name}
                        ...
                        <div className="flex flex-col flex-1 justify-between">
                            <div>
                                ...
                                <CardContent className="space-y-4">
                                    ...
                                    <div className="space-y-2">
                                        {[
                                            { icon: Clock, text: course.time },
                                            { icon: BookOpen, text: `${10} aulas` },
