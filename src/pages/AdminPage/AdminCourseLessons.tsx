        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {lessons.map((lesson, index) => (
                    <Card
                        key={lesson.id}
                        className={`flex flex-col bg-white/5 backdrop-blur-md border transition-all duration-300 hover:scale-105 ${lesson.completed
                    ...
                    >
                        <CardHeader className="pb-3">
                            <div className="flex items-start justify-between">
                                ...
                                <div
                                    className={`px-2 py-1 rounded-full text-xs font-medium ${lesson.completed
